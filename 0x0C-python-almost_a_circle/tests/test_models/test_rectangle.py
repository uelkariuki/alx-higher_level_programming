...
class TestRectangle(unittest.TestCase):
    ...
    def test__str__override(self):
        ...
        self.assertEqual(str2.id, 33)
        self.assertEqual(str2.__str__(), "[Rectangle] (33) 1/0 - 5/5")
    ...
    def test_to_dictionary(self):
        ...
        self.assertEqual(recty1.id, 36)
        self.assertEqual(recty1.__str__(), "[Rectangle] (36) 1/9 - 10/2")
        recty_dict = recty1.to_dictionary()
        self.assertEqual(recty_dict.__str__(), "{'id': 36,\
 'width': 10, 'height': 2, 'x': 1, 'y': 9}")
        ...
        self.assertEqual(recty2.__str__(), "[Rectangle] (37) 0/0 - 1/1")

        recty2.update(**recty_dict)
        self.assertEqual(recty2.__str__(), "[Rectangle] (36) 1/9 - 10/2")
