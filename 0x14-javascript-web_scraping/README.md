...
* How to use <code speechify-initial-font-family="Menlo, Monaco, Consolas, &quot;Courier New&quot;, monospace" speechify-initial-font-size="12.6px">request</code> and fetch API
* How to read and write a file using <code speechify-initial-font-family="Menlo, Monaco, Consolas, &quot;Courier New&quot;, monospace" speechify-initial-font-size="12.6px">fs</code> module
## Tasks
